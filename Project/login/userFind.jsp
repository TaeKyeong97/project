...
<c:choose>
	<c:when test="${EM_id==null}">
		<div class="l-wrap">
		  ...
		  <form action="searchPassword.ops?URL=${URL}&&kind=corp" name="log2" method="post" class="log2" style="<c:choose><c:when test="${logCk.equals('1')||logCk=='1'}">display:block;</c:when><c:otherwise>display:none;</c:otherwise></c:choose>">																			
			  <div class="fom-wrap">
