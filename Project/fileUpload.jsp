...
<body>
<c:choose>
	<c:when test="${pjbRight.mainP_Approval=='1'}">
	<div class="x-pwrap">
	...
	<section class="x-body">
	              ...
	              <div class="x-xgroup-b">
	                ...
	                <div class="x-xFileM">
	                  ...
	                  <ul>
	                    <li>
	                      <span></span>
	                      <a href="#" onclick="GroupProjectOpenS('GongYu','${param.pj_no}','${opgp.pjG_no}','1')">공유페이지</a>
	        ...
	        <article id="GpContent" style="width:100%;">
	          ...
	          <form action="fileUploadPro.op?pj_no=${param.pj_no}&&pjgp_no=${param.pjgp_no}&&page=${param.page}" method="post" enctype="multipart/form-data">
	          <input type="submit" value="저장하기" style=" background: #180505; border:0; color: #fff; padding: 9px 18px; float:right; margin:15px; ">
	          	<div class="filebox bs3-primary" style=" padding:19px 22px; position: relative; border:1px solid #4e5366; background:#595e73; clear:right;">
					<label for="files" style="width:100%; height:52px; position:absolute;"></label><input class="upload-name" value="파일선택" disabled="disabled" style="width:116px; height:37px; background:#595e73; color:#fff; border:0;"> 
					<label for="files" style="padding:9px 12px; background:#6081f7; float:right;">파일 업로드</label>
					<input type="file" id="files" name="files" class="upload-hidden" style="display:none;"> 		
				</div>
				<script>
				...
				<input type="hidden" name="pjgp_no" value="${param.pjgp_no}">
	          </form>
	        </article>
	      </section>
